...
// "use strict";
// // var list = require("../data/json.js");
// import list from "../data/json.js";
// var list_data = JSON.parse(list);
// console.log(list);
...
for(var list of lists){
  list.onmouseover = function(){
    ...
    this.lastElementChild.firstElementChild.style.color="#f00"
  }
  list.onmouseout = function(){
    this.style.borderBottom="";
    this.lastElementChild.firstElementChild.style.color="#000";
  }
}
